										...
										{navigation.map((item) => (
											<Link
												...
												className={classNames(
													item.current
														? 'bg-slate_700  text-white'
														: 'text-gray-300 hover:bg-slate_700 hover:text-white',
						...
						<div className="space-y-1 px-2 pb-3 pt-2">
							{navigation.map((item) => (
								<Disclosure.Button
									...
									className="text-gray-300 hover:bg-slate_700 hover:text-white block rounded-md px-3 py-2 text-base font-medium"
									aria-current={item.current ? 'page' : undefined}
								>
									{item.name}
								</Disclosure.Button>
